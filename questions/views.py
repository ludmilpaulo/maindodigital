...
from students.models import StuExam_DB,StuResults_DB
from questions.models import QPForm
from questions.models import QForm
from django.utils import timezone
    ...
    if permissions:
        ...
        if request.method == 'POST' and permissions:
            ...
            if form.is_valid():
                ...
                exam.save()
                form.save_m2m()
                return redirect('question:view_exams')
        ...
        return redirect('question:view_exams_student')
    ...
    if permissions:
        ...
        if request.method == 'POST' and permissions:
            ...
            if form.is_valid():
                ...
                exam.save()
                form.save_m2m()
                return redirect('question:faculty-add_question_paper')
    ...
    if permissions:
        ...
        if request.method == 'POST' and permissions:
            ...
            if form.is_valid():
                ...
                exam.save()
                form.save_m2m()
                return redirect('question:faculty-addquestions')
